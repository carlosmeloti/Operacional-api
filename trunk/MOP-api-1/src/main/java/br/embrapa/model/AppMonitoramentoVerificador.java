...
public class AppMonitoramentoVerificador {
	...
	private AppMonitoramento cadEmpresa;
	...
	@ManyToOne
	@JoinColumn(name="r17_cdmonitoramento")
	private AppMonitoramento cdmonitoriamento;
	...
	public AppMonitoramento getCadEmpresa() {
		return cadEmpresa;
	}

	public void setCadEmpresa(AppMonitoramento cadEmpresa) {
	...
	public AppMonitoramento getCdmonitoriamento() {
		return cdmonitoriamento;
	}

	public void setCdmonitoriamento(AppMonitoramento cdmonitoriamento) {
		this.cdmonitoriamento = cdmonitoriamento;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AppMonitoramentoVerificador other = (AppMonitoramentoVerificador) obj;
